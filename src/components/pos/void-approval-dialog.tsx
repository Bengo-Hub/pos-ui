...
/**
 * VoidApprovalDialog collects manager authorization to void a bill in THREE ways:
 ...
 *     the manager isn't physically present. The code goes straight to the void call (void_code).
 */
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative z-[61] w-full max-w-sm mx-4 bg-card border border-border rounded-2xl shadow-xl p-5 space-y-4">
        ...
        <p className="text-xs text-muted-foreground text-center">
          A manager must approve to void {orderNumber ? `bill #${orderNumber}` : 'this bill'}.
        </p>
