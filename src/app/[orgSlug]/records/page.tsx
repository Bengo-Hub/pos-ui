...
import { ClipboardPlus, FileText, Loader2, Plus, Search, UserPlus, X } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Register patients and open OPD visits</p>
          </div>
        </div>
...
export default function RecordsPageGated() {
  return (
    <ModuleGate moduleKey="records" fallback={<ModuleUnavailablePage moduleKey="records" />}>
      <RecordsPage />
    </ModuleGate>
  );
}
